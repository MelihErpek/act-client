  ...
  const Name = () => {
    if (userData.user) {
      if (userData.user.user) {
        return <div className="flex space-x-2 text-lg  font-semibold bg-red-100 p-3 ">Welcome {userData.user.user.name}</div>;
      }
    } else {
      return <div></div>;
    }
          ...
          <header className=" text-black p-4 ">
            <div className="flex flex-col md:flex-row md:justify-between items-center w-full">
              ...
              <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-14 md:mr-40">
                ...
                <Name/>
                <a className="text-black italic font-bold " href="/guidelines">
                  PANEL
                </a>
                <a
                  className="bg-red-600 hover:bg-red-800 text-white font-bold px-9 py-3 rounded transition-colors duration-300"
                  href="/home"
                  onClick={() => logOut()}
                >
                  LOG OUT
        ...
        <div>
          <header className=" text-black p-4 ">
            <div className="flex flex-col md:flex-row md:justify-between items-center w-full">
              ...
              <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-14 md:mr-40">
                <a className="text-black italic font-bold " href="/">
                  HOME
                </a>
                <div className="text-black italic font-bold">ABOUT US</div>
                <div className="text-black italic font-bold">CONTACT US</div>
                <a
                  className="bg-red-600 hover:bg-red-800 text-white font-bold px-9 py-3 rounded transition-colors duration-300"
                  href="./login"
                >
